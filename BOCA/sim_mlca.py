...
def main(domain: str, q: float, seed: int, acquisition: str):
    ...
    NN_parameters = load_HPO_winners(
        os.path.join(os.getcwd(), "hpo_results_mvnnUB4", "winner"), domain=domain, q=q
    )
    print("HPO LOADED")
    ...
    RS_parameters = {"attempts": 10000, "weight_uUB_acquisition": 0.95}
    # -------------------
