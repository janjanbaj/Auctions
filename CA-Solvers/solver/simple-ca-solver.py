...
# Quick Functions:
add_constraints = lambda problem, constraints: [
    problem.addConstraint(c) for c in constraints
]
...
non_overlaping_constraints = [
    lpSum([bid_vars[i] for i in bids]) <= 1 for item, bids in item_overlap.items()
]
